...
local myData = loadstring(game:HttpGet("https://raw.githubusercontent.com/z4gs/scripts/master/Settings.lua"))()("Truly an autofarm", {
    Skills = {
        E = false,
        F = false,
        C = false,
...
player.PlayerFolder.Stats.Reputation.Changed:Connect(function(value)
    if array.autofarm then
        labels("Rep", value - labels.Rep.oldval, value)
    end
end)
